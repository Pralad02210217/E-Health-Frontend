...
export const HeartPulseIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M3.6 15.2A5 5 0 0 1 2 11.3C2 8.5 4.2 6.3 7 6.3c1.2 0 2.3.5 3 1.3.7-.8 1.8-1.3 3-1.3 2.8 0 5 2.2 5 5 0 1.2-.4 2.3-1.1 3.2L12 21l-8.4-5.8z" />
    <path d="M8 14h.01" />
    <path d="M12 11h.01" />
    <path d="M16 14h.01" />
  </svg>
...
export const SchoolIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M4 6L12 2l8 4-8 4-8-4z" />
    <path d="M4 10v6c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2v-6" />
    <path d="M12 22v-6" />
  </svg>
);
